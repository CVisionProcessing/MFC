...
def train_argument_parser():
    ...
    parser.add_argument('--proc_name', type=str, default='VOS',
                        help='proc name')
    parser.add_argument('--arch', type=str, default='MFC',
                        help='arch name')
    ...
    parser.add_argument('--img_size', type=int, default=256,
                        help='image size')
    parser.add_argument('--datapath', default='disk1/ztq/experiment_1/little_data',
                        help='Data path for Kinetics')
    parser.add_argument('--savepath', type=str, default='disk1/ztq/mfc_t/ckpt',
